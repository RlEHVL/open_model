    ...
    def get_tts_engine(engine_type, **kwargs) -> Type[TTSInterface]:
        if engine_type == "azure_tts":
            ...
            return VoiceVoxTTSEngine(
                ...
                use_korean_preprocessing=kwargs.get("use_korean_preprocessing", True),
                apply_hmm_to_voice=kwargs.get("apply_hmm_to_voice", True),
                hmm_depth=kwargs.get("hmm_depth", 0.7),
            )
        else:
